...
import com.example.musicstreamapp.databinding.SectionSongListRecylerRowBinding
...
class SectionSongListAdapter(private val songIdList: List<String>) : RecyclerView.Adapter<SectionSongListAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(private val binding: SectionSongListRecylerRowBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = SectionSongListRecylerRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
